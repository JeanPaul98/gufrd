...
import com.acl.formaliteagricultureapi.dto.produit.DetPhytosanitaireProduitSansTraitementDto;
...
@Getter
@Setter
@Schema(description ="PhytosanitaireObtentionCertificatClientListDto" )
public class PhytosanitaireObtentionCertificatProduitSansTraitementClientListDto {
...
//Debut Phytosanitaire Obtention de Certificat
    ...
    private List<DetPhytosanitaireProduitSansTraitementDto> detPhytosanitaireProduitDtos;
	...
	public PhytosanitaireObtentionCertificatProduitSansTraitementClientListDto(Long idFormalite,  String numGenerer,
			...
			List<DetPhytosanitaireProduitSansTraitementDto> detPhytosanitaireProduitDtos) {
