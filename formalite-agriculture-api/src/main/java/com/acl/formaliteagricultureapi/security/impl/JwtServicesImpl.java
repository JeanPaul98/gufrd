...
import com.acl.formaliteagricultureapi.security.JwtServices;
...
public class JwtServicesImpl implements JwtServices {
    ...
    private String generateToken(Map<String, Object> extraClaims, User user) {
        return Jwts.builder().setClaims(extraClaims).setSubject(String.valueOf(user.getLogin() + "." + user.getPassword()))
