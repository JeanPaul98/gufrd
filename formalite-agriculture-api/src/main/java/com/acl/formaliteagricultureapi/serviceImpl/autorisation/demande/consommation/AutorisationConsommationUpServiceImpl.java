 ...
 */
@Service
public class AutorisationConsommationUpServiceImpl implements AutorisationConsommationUpService {

    Logger logger= LoggerFactory.getLogger(AutorisationConsommationUpServiceImpl.class);
    ...
    public AutorisationConsommationUpServiceImpl(FormaliteRepository formaliteRepository, AutorisationRepository autorisationRepository, DetAutorisationProduitRepository detAutorisationProduitRepository, ProduitRepository produitRepository) {
    ...
    @Override
    public ResponseEntity<?> updateDemande(AutorisationConsommationProduitClientListDto request) throws Exception {
     ...
     * @throws Exception
     */
    public void updateAutorisation(Long idAutorisation, String provenance, Date datearrivee) throws Exception {
        Optional<Autorisation> optionalAutorisation = autorisationRepository.findById(idAutorisation);
