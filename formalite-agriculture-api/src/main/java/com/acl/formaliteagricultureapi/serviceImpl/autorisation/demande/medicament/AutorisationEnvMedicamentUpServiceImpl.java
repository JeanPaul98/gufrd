 ...
 */
@Service
public class AutorisationEnvMedicamentUpServiceImpl implements AutorisationEnvMedicamentUpService {
    ...
    public AutorisationEnvMedicamentUpServiceImpl(FormaliteRepository formaliteRepository, AutorisationRepository autorisationRepository, DetAutorisationProduitRepository detAutorisationProduitRepository, ProduitRepository produitRepository) {
