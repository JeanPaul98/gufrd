 ...
 */
@Service
public class InspectionPhytoPharmaClientCRUDServiceImpl implements InspectionPhytoPharmaClientCrudService {

    private final Logger logger = LoggerFactory.getLogger(InspectionPhytoPharmaClientCRUDServiceImpl.class);
    ...
    public InspectionPhytoPharmaClientCRUDServiceImpl(PhytosanitaireRepository phytosanitaireRepository,
                                                      ...
                                                      StructureRepository structureRepository, TypeAutorisationRepository typeAutorisationRepository, TypePieceJointeRepository typePieceJointeRepository, PieceJointeRepository pieceJointeRepository) {
    ...
    @Override
    @Transactional
    public ResponseEntity<?> create(PhytosanitaireProduitPhytopharmaClientDto request) {
        ...
        return saveFormalite(request.getAtp(), request.getNomNavire(),
                ...
                request.getCompteClient(),request.getNumeroDossier(),request.getPieceJointeDtoList(),request.getNif());
    }
    ...
    public PhytoSanitaire savePhytosanitaire(String nomDemandeur, String professionDemandeur,
        ...
        PhytoSanitaire phytoSanitaire = new PhytoSanitaire(nomDemandeur, professionDemandeur, adresseDemandeur,
                lieuInspection, structureDemandeur);
        Optional<TypeInspPhyto> optionalTypeAutorisation = typePhytosanitaireRepository.
                findByRef(env.getProperty("message.type.phytosanitaire.ref.pharma"));
    ...
    @Override
    @Transactional
    public ResponseEntity<?> validerDemande(PhytosanitaireProduitPhytopharmaClientListDto request) throws Exception {

        updatePhytosanitaire(request.getIdPhytosanitaire(),request.getNomDemandeur(),request.getProfessionDemandeur()
        ,request.getAdresseDemandeur(), request.getLieuInspection()
//                , request.getDatePrevueInspection()
        );
...
//            optionalPhytoSanitaire.get().setDatePrevueInspection(datePrevueInspection);
            ...
            throw  new DocumentNotFoundException(env.getProperty("message.not.found.entity"));
    ...
    @Override
    public ResponseEntity<?> cancel(PhytosanitaireProduitPhytopharmaClientListDto request) {
