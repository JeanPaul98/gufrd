...
export class CreateService {
  ...
  createDemande(demandInfos: DemandiocavSimpleModel): Observable<number | undefined> {
  ...
  editDemande(demandInfos: DemandiocavSimpleModel): Observable<DemandiocavSimpleModel | undefined> {
