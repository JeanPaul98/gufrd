...
import {DemandiocavCompletModel,DemandiocavModel} from '../../../../../../../../src/app/models/demand-iocav.model';
...
export class DemandService {
  ...
  currentDemandsSubject = new BehaviorSubject<DemandiocavModel[]>([]);
  currentDemandSubject = new BehaviorSubject<DemandiocavCompletModel>({} as DemandiocavCompletModel);
  ...
  getDemandNotSubmitted(): Observable<DemandiocavModel[] | undefined> {
  ...
  getDemandSubmitted(): Observable<DemandiocavModel[] | undefined> {
  ...
  getDemandAccepted(): Observable<DemandiocavModel[] | undefined> {
    return this.httpDemandService.getDemandAccepted().pipe(
      map((res) => res.result),
      switchMap((res) => {
        const demandAeaaWithUrl = res.map((demand: DemandiocavModel) => {
  ...
  getDemandRejected(): Observable<DemandiocavModel[] | undefined> {
  ...
  getDemandProcessed(): Observable<DemandiocavModel[] | undefined> {
  ...
  nowSubmitDemand(submitDemandModel: SubmitDemandModel): Observable<DemandiocavModel | undefined> {
  ...
  nowDeleteDemand(submitDemandModel: SubmitDemandModel): Observable<DemandiocavModel | undefined> {
