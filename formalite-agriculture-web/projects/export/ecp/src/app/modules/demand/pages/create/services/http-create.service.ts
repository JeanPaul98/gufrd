...
import { DemandAeaaModel, DemandAeaaSimpleModel,DemandAeaaCompletModel } from '../../../../../../../../../../src/app/models/demand-aeaa.model';
...
export class HttpCreateService extends BaseHttpService {
  ...
  createDemande(demandInfos: DemandAeaaCompletModel): Observable<HttpResponseModel<DemandAeaaCompletModel>> {
    return this.http.post<HttpResponseModel<DemandAeaaCompletModel>>(`${this.API_USERS_URL}/v1/veterinaire/cuirspeaux/insert`,demandInfos, {
      headers: this.httpHeader()
    });
  }
  ...
  editDemande(demandInfos: DemandAeaaSimpleModel): Observable<HttpResponseModel<DemandAeaaSimpleModel>> {
    return this.http.post<HttpResponseModel<DemandAeaaSimpleModel>>(`${this.API_USERS_URL}/v1/veterinaire/cuirspeaux/validerdemande
`, demandInfos, {
      headers: this.httpHeader()
    });
  }
