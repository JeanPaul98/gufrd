...
export class Step01Component implements OnInit {
  ...
  initForm(): void {
    ...
    this.step1InfoNavireFrom.patchValue(JSON.parse(localStorage.getItem('step1EditADT') as string) ?? {});
  ...
  onClickNext() {
    ...
    localStorage.setItem('step1EditADT', JSON.stringify(this.step1InfoNavireFrom.value))
