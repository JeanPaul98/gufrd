...
export class Step02Component  implements OnInit {
  ...
  initForm(): void {
    ...
    const savedData = JSON.parse(localStorage.getItem('step2EditADT') as string)
  ...
  removeProduct(index: number): void {
    ...
    localStorage.setItem('step2EditADT', JSON.stringify(this.step2InfoProduitsFrom.value))
  }
