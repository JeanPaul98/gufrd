...
export class Step03Component {
  fileUploads: UploadFilesModel = localStorage.getItem('step3ADT') ?
    JSON.parse(localStorage.getItem('step3ADT') as string) :
  ...
  onClickNext() {
    ...
    localStorage.setItem('step3ADT', JSON.stringify(dataToStorage));
