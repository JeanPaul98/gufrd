...
export class Step03Component {
  fileUploads: UploadFilesModel = localStorage.getItem('step3AEAA') ?
    JSON
    .parse(localStorage.getItem('step3AEAA') as string)
   : {};
  ...
  onClickNext() {
    ...
    localStorage.setItem('step3AEAA', JSON.stringify(dataToStorage))
