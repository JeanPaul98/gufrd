...
export class Step01Component implements OnInit {
  ...
  constructor(private stepperService: StepperService, private service: CreateService, private _formBuilder?: UntypedFormBuilder) {
  ...
  initForm(): void {
    ...
    this.step1InfoShipFrom.patchValue(JSON.parse(localStorage.getItem('step1IPCC') as string) ?? {});
  ...
  onClickNext() {
    ...
    localStorage.setItem('step1IPCC', JSON.stringify(this.step1InfoShipFrom.value))
