...
export class Step01Component implements OnInit {
  ...
  initForm(): void {
    ...
    this.step1InfoShipFrom.patchValue(JSON.parse(localStorage.getItem('step1EditIPCC') as string) ?? {});
  ...
  ngOnInit(): void {
    this.initForm()
    const shipInfo = JSON.parse(localStorage.getItem('demandDetailIPCC') as string);
  ...
  onClickNext() {
    ...
    localStorage.setItem('step1EditIPCC', JSON.stringify(this.step1InfoShipFrom.value))
