...
export class Step01Component implements OnInit {
  ...
  initForm(): void {
    ...
    this.step1InfoShipFrom.patchValue(JSON.parse(localStorage.getItem('step1IPPPP') as string) ?? {});
  ...
  onClickNext() {
    ...
    localStorage.setItem('step1IPPPP', JSON.stringify(this.step1InfoShipFrom.value))
