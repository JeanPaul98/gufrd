...
export class Step02Component  implements OnInit {
  ...
  initForm(): void {
    ...
    const savedData = JSON.parse(localStorage.getItem('step2EditAGREMENT') as string)
  ...
  removeProduct(index: number): void {
    ...
    localStorage.setItem('step2EditAGREMENT', JSON.stringify(this.step2InfoProduitsFrom.value))
  }
