...
export class HttpDemandService extends BaseHttpService {
  ...
  getDemandNotSubmitted(): Observable<HttpResponseModel<DemandAeaaModel[]>> {
  ...
  getDemandBadgeCount(): Observable<HttpResponseModel<BadgesCountModel>> {
  ...
  getDemandSubmitted(): Observable<HttpResponseModel<DemandAeaaModel[]>> {
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
  ...
  getDemandAccepted(): Observable<HttpResponseModel<DemandAeaaModel[]>> {
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
  ...
  getDemandRejected(): Observable<HttpResponseModel<DemandAeaaModel[]>> {
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
  ...
  getDemandProcessed(): Observable<HttpResponseModel<DemandAeaaModel[]>> {
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
