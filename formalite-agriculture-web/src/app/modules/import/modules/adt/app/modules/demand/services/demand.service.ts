...
export class DemandService {
  ...
  back() {
    // this.location.back();
    this.router.navigate(['/importations/adt/demand', 'submitted'])
  ...
  confirmPayement(idFormalite: number): Observable<DemandAeaaModel | undefined> {
    return this.httpDemandService.confirmPayement(idFormalite).pipe(
      map((res) => res.result),
      catchError((err) => {
        return throwError(() => err);
      }),
