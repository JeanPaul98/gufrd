...
export class HttpDemandService extends BaseHttpService {
  ...
  getDemandNotSubmitted(
    ...
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
      `${this.API_USERS_URL}/v1/autorisation/alimentAnimaux/nonsoumis`,
      {
  ...
  getDemandBadgeCount(
    ...
    return this.http.get<HttpResponseModel<BadgesCountModel>>(
      `${this.API_USERS_URL}/v1/autorisation/alimentAnimaux/statistiqueDemande`,
      {
        headers: this.httpHeader(),
      }
    );
  ...
  acceptDemand(submitDemand: SubmitDemandModel): Observable<HttpResponseModel<DemandAeaaModel>> {
    return this.http.post<HttpResponseModel<DemandAeaaModel>>(
      `${this.API_USERS_URL}/v1/autorisation/alimentAnimaux/accepterdemande
`,
      submitDemand,
      {
        headers: this.httpHeader(),
  ...
  getDemandSubmitted(
    ...
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
      `${this.API_USERS_URL}/v1/autorisation/alimentAnimaux/soumis`,
      {
        headers: this.httpHeader(),
      }
    );
  ...
  getDemandAccepted(
    ...
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
      `${this.API_USERS_URL}/v1/autorisation/alimentAnimaux/accepter`,
      {
        headers: this.httpHeader(),
      }
    );
  ...
  getDemandRejected(
    ...
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
      `${this.API_USERS_URL}/v1/autorisation/alimentAnimaux/rejetee`,
      {
        headers: this.httpHeader(),
      }
    );
  ...
  getDemandProcessed(
    ...
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
      `${this.API_USERS_URL}/v1/autorisation/alimentAnimaux/traiter`,
      {
        headers: this.httpHeader(),
      }
    );
