...
export class HttpDemandService extends BaseHttpService {
  ...
  getDemandNotSubmitted(
    ...
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
      `${this.API_USERS_URL}/v1/autorisation/consommation/nonsoumis`,
      {
  ...
  getDemandBadgeCount(
    ...
    return this.http.get<HttpResponseModel<BadgesCountModel>>(
      `${this.API_USERS_URL}/v1/autorisation/consommation/statistiqueDemande`,
      {
        headers: this.httpHeader(),
      }
    );
  ...
  acceptDemand(submitDemand: SubmitDemandModel): Observable<HttpResponseModel<DemandAeaaModel>> {
    return this.http.post<HttpResponseModel<DemandAeaaModel>>(
      `${this.API_USERS_URL}/v1/autorisation/consommation/accepterdemande
`,
      submitDemand,
      {
        headers: this.httpHeader(),
  ...
  getDemandSubmitted(
    ...
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
      `${this.API_USERS_URL}/v1/autorisation/consommation/soumis`,
      {
        headers: this.httpHeader(),
      }
    );
  ...
  getDemandAccepted(
    ...
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
      `${this.API_USERS_URL}/v1/autorisation/consommation/accepter`,
      {
        headers: this.httpHeader(),
      }
    );
  ...
  getDemandRejected(
    ...
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
      `${this.API_USERS_URL}/v1/autorisation/consommation/rejetee`,
      {
        headers: this.httpHeader(),
      }
    );
  ...
  getDemandProcessed(
    ...
    return this.http.get<HttpResponseModel<DemandAeaaModel[]>>(
      `${this.API_USERS_URL}/v1/autorisation/consommation/traiter`,
      {
        headers: this.httpHeader(),
      }
    );
