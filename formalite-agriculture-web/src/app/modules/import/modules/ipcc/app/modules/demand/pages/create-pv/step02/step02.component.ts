...
import {
  CreateService
} from "../../../../../../../../../../../../projects/import/aeaa/src/app/modules/demand/pages/create/services/create.service";
...
export class Step02Component implements OnInit {
  ...
  initForm(): void {
    ...
    this.step2InfoProduitsForm = this._formBuilder!.group({
      detPvProduitDtos: this._formBuilder!.array([])
    });
    ...
    if (savedData && savedData.detPvProduitDtos) {
      savedData.detPvProduitDtos.forEach(() => {
  ...
  get products(): FormArray {
    return this.step2InfoProduitsForm.get('detPvProduitDtos') as FormArray;
  }
  ...
  createProductGroup(): FormGroup {
    return this._formBuilder!.group({
      ...
      matiereActive: [null, Validators.required],
      codProduit: [null, Validators.required],
  ...
  getControls() {
    return (this.step2InfoProduitsForm.get('detPvProduitDtos') as FormArray).controls;
  }
