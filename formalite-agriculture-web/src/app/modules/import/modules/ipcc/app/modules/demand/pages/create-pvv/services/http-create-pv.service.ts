...
import {PVAIPCLModel} from "../../../../../../../../../../models/admin/pv-aipcl.model";
...
export class HttpCreatePVService extends BaseHttpService {
  ...
  createPV(pvInfos: PVAIPCLModel): Observable<HttpResponseModel<PVAIPCLModel>> {
    return this.http.post<HttpResponseModel<PVAIPCLModel>>(`${this.API_USERS_URL}/v1/pv/phytonavire/insert`, pvInfos, {
      headers: this.httpHeader()
    });
  }
