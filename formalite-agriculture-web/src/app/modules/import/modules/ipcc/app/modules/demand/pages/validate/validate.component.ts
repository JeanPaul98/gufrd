...
export class ValidateComponent implements OnInit, AfterViewInit {
  ...
  constructor(private demandService: DemandService, private location: Location,private cdr:ChangeDetectorRef, private router: Router, private _formBuilder?: UntypedFormBuilder) {
