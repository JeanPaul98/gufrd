...
export class CreatePvComponent implements OnInit {
  currentStep =
    JSON.parse(localStorage.getItem('currentStepPVIPN') as string) ?? 1;
  ...
  ngOnInit(): void {
    ...
    this.router.navigate([
      '/importations/ipn/demand/create-pv',
  ...
  onClickBack() {
    ...
    // this.demandService.customBack('/importations/ipn/demand/'+this.curentTab);
  }
}
