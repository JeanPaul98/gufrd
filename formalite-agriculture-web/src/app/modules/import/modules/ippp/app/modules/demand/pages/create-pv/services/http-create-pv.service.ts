...
export class HttpCreatePVService extends BaseHttpService {
  ...
  createPV(pvInfos: PVIPPPModel): Observable<HttpResponseModel<PVIPPPModel>> {
    return this.http.post<HttpResponseModel<PVIPPPModel>>(`${this.API_USERS_URL}/v1/pv/phytoPharma/insert`, pvInfos, {
      headers: this.httpHeader()
    });
  }
