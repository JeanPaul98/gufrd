...
import {PVInspecteurModel, PVProduitModel} from "../../../../../../../../../../models/admin/pv-ippp.model";
...
export class Step01Component implements OnInit {
  ...
  initForm(): void {
    this.step1InfoPVFrom = this._formBuilder!.group({
      ...
      agrementSocieteImportatrice: [null, Validators.required],
      homologationProduit: [null, Validators.required],
    ...
    this.step1InfoPVFrom.patchValue(JSON.parse(localStorage.getItem('step1PVIPPP') as string) ?? {});
  ...
  onClickNext() {
    ...
    localStorage.setItem('step1PVIPPP', JSON.stringify(this.step1InfoPVFrom.value))
