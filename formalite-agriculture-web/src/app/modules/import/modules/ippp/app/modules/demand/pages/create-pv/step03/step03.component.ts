...
export class Step03Component implements OnInit {
  ...
  initForm(): void {
    ...
    const savedData = JSON.parse(localStorage.getItem('step3PVIPPP') as string);
  ...
  removeProduct(index: number): void {
    ...
    localStorage.setItem('step3PVIPPP', JSON.stringify(this.step3InfoInspecteurForm.value))
  }
