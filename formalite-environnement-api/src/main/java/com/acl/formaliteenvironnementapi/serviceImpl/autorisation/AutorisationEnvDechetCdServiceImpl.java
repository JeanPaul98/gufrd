...
@Service
public class AutorisationEnvDechetCdServiceImpl implements AutorisationEnvDechetCdService {
    ...
    public AutorisationEnvDechetCdServiceImpl(FormaliteRepository formaliteRepository,
    ...
    @Override
    @Transactional
    public ResponseEntity<?> create(AutorisationEnvDechetDto request) {
    ...
    private Autorisation saveAutorisation() {
        ...
        Optional<TypeAutorisation> typeAutorisation = typeAutorisationRepository.
                findByRef(env.getProperty("message.type.autorisation.ref.dechet"));
    ...
    private ResponseEntity<?> saveFormalite(String atp, String compteClient, String imo, String nomNavire,
        ...
        formalite.setNumGenere(System.currentTimeMillis()+env.getProperty("message.numero.generer.env.autorisation") );
    ...
    @Override
    @Transactional
    public ResponseEntity<?> validerDemande(AutorisationEnvListDechetDto request) throws Exception {
        return  null;
    }
