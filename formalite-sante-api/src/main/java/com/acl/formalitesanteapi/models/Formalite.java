...
import com.acl.formalitesanteapi.models.enumeration.StatutPaiement;
...
@Setter
@NoArgsConstructor
@Table(name = "FORMALITE", schema = "USERFMS")
...
public class Formalite implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "S_FORMALITE_SANTE")
    @SequenceGenerator(sequenceName = "S_FORMALITE_SANTE", allocationSize = 1, name = "S_FORMALITE_SANTE")
    @Column(name = "ID")
    private Long id;
