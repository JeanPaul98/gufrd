package com.acl.vbs.fret.handlers;

import com.acl.vbs.fret.exceptions.*;
import com.acl.vbs.fret.responses.ErrorFieldResponse;
import com.acl.vbs.fret.responses.ErrorResponse;
...
//    }
    ...
    @ExceptionHandler(DestinataireMarchandiseNotFoundException.class)
    public ResponseEntity<HttpResponse> destinataireMarchandiseNotFoundException(DestinataireMarchandiseNotFoundException exception) {
        log.error(exception.getMessage());
        return createHttpResponse(NOT_FOUND, exception.getMessage());
    }
    ...
    @ExceptionHandler(GarantNotFoundException.class)
    public ResponseEntity<HttpResponse> garantNotFoundException(GarantNotFoundException exception) {
        log.error(exception.getMessage());
        return createHttpResponse(NOT_FOUND, exception.getMessage());
    }
...
//    }
    ...
    @ExceptionHandler(ChargeurNotFoundException.class)
    public ResponseEntity<HttpResponse> chargeurNotFoundException(ChargeurNotFoundException exception) {
        log.error(exception.getMessage());
        return createHttpResponse(NOT_FOUND, exception.getMessage());
    }

    @ExceptionHandler(ParametrageNotFoundException.class)
    public ResponseEntity<HttpResponse> parametrageNotFoundException(ParametrageNotFoundException exception) {
        log.error(exception.getMessage());
        return createHttpResponse(NOT_FOUND, exception.getMessage());
    }

    @ExceptionHandler(DeclarantNotFoundException.class)
    public ResponseEntity<HttpResponse> declarantNotFoundException(DeclarantNotFoundException exception) {
        log.error(exception.getMessage());
        return createHttpResponse(NOT_FOUND, exception.getMessage());
    }
