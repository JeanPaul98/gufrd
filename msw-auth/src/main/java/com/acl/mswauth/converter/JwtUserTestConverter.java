...
@Component
public class JwtUserTestConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    @Value("${jwt.auth.client.user.resource-id}")
    ...
    private KeyCloakUser getKeycloakUser(Jwt jwt) {
        ...
        logger.info("keycloakUser for Test user interface, {}", user);
