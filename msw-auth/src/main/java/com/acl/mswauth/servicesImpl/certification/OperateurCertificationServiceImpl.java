 ...
 */
@Service
public class OperateurCertificationServiceImpl implements OpertateurCertificationService {

    private Logger logger = LoggerFactory.getLogger(OperateurCertificationServiceImpl.class);
    ...
    public OperateurCertificationServiceImpl(UtilService utilService, SocieteRepository societeRepository,
                                             DemandeCertificationRepository demandeCertificationRepository, EmailService emailService) {
    ...
    public ResponseEntity<?> insert(DmdCertificationDto request) {
        Optional<Societe> clients = societeRepository.findByNif(request.getNif());
        ...
        if(clients.isPresent()) {
            ...
            MailInfoDto mailInfoDto = new MailInfoDto(request.getEmail(), "CODE VERIFICATION",
                  sendCodeTemplate(demandCertification.getCode(), clients.get().getRaisonSociale()) );
